        ...
        <Reveal delay={0.1}>
          <Accordion
            ...
            styles={{
              ...
              control: { fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif", fontWeight: 800, fontSize: 16, padding: '20px 22px', color: 'var(--text)', letterSpacing: '-0.01em' },
              panel: { fontSize: 15, color: 'var(--text-muted)' },

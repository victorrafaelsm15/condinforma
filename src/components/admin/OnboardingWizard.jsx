...
import { Modal, Stepper, Text, Button, TextInput } from '@mantine/core';
import { Building2, DoorOpen, ListChecks, QrCode, PartyPopper } from 'lucide-react';
...
export default function OnboardingWizard({ opened, onClose, accountId, hasCondominio, firstCondominio, onCondominioCreated }) {
